...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference('Ingredient.count') do
      post ingredients_url, params: { ingredient: { completed: @ingredient.completed, name: @ingredient.name, quantity: @ingredient.quantity } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { completed: @ingredient.completed, name: @ingredient.name, quantity: @ingredient.quantity } }
